...
public class ModItems {
    public static Item registerItem(String name, ItemConvertible item) {
        return Registry.register(Registries.ITEM, Identifier.of(VietnamsDelight.MOD_ID, name), (Item) item);
    }
    ...
    public static final Item RICEBATTER = registerItem(
            "rice_batter",
            new ConsumableItem(
                vectorwing.farmersdelight.common.registry.ModItems.foodItem(ModFoodComponents.RICEBATTER_FOOD_COMPONENT), // todo: could be wrong
                false,
                false
            )
    );
