...
import net.minecraft.entity.effect.StatusEffectInstance; // class_1293 is used for potion effects
import net.minecraft.entity.effect.StatusEffects; // class_1294 contains predefined effects
import net.minecraft.component.type.FoodComponent; // class_4174 is the base class for food components
...
public class ModFoodComponents {
   ...
   public static final FoodComponent BANHMI = new FoodComponent.Builder().nutrition(3).saturationModifier((float) 4/3).build();
}
